...
def test_self_weight():
    ...
    lc = LoadCase(1., 76000, model.N, 9.81, 112800, asb.OperatingPoint(atmosphere=asb.Atmosphere(7000.), alpha=.87, velocity=269.), les, tes, airfs, bres=25, cres=8, aeroelastic=True, nneighs=10)

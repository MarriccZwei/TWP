...
class UnpackedPoints():
    ...
    def __init__(self, inpt:str):
        ...
        self.ffb = pts[6][1] #extreme pts for backwards compatibility
        self.frb = pts[6][-2]
        self.frt = pts[6][-1]
        self.fft = pts[6][0]

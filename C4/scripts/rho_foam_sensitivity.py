...
rho_fs = [100, 175, 250.2, 325, 400, 475, 550]
...
for rho_f in rho_fs:
    ...
    optimiser = Optimiser(desvarsInit, [mc.LC_INFO[0], mc.LC_INFO[3]], mc.GEOM_SOURCE, mc.HYPERPARAMS, mc.MASSES, mc.N, materials, resNoBuckl, mc.G0, mc.MTOM, mc.NAIRFS, mc.LBUCKLSF,

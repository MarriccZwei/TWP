...
optimiser = Optimiser(desvarsInit, [mc.LC_INFO[0], mc.LC_INFO[1], mc.LC_INFO[3]], mc.GEOM_SOURCE, hypers, mc.MASSES, mc.N, mc.MATERIALS, resNoBuckl, mc.G0, mc.MTOM, mc.NAIRFS, mc.LBUCKLSF,

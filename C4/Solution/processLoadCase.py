...
from ..Geometry.Exclusion import Exclusion
    ...
    if plot:
        ...
        if savePath is None:
            ...
            with open(savePath+"failure_margins.txt", "w") as file:
                ...
                file.write(f"buckling eigenvalues: {eigvals}")
...
def process_aeroelastic_load_case(model:Pyfe3DModel, lc:LoadCase, plot:bool=False, savePath:str=None, k:int=7, returnOmegan=False, returnBoth=False):
    ...
    """
    model.KC0_M_update(1000.*56052/model.N) #modal solution
